...
ActiveRecord::Schema.define(version: 2020_11_05_042314) do
  ...
  create_table "carts", force: :cascade do |t|
    t.integer "member_id"
    t.string "total_cost_string", default: "$0.00", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "ordered_date_string"
    t.string "shipped_date_string"
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["brand_id", "product_number", "images"], name: "index_products_on_brand_id_and_product_number_and_images", unique: true
  end
