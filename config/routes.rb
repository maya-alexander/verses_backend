...
#           api_v1_user_plan_membership GET    /api/v1/users/:user_id/plan_membership(.:format)                                         api/v1/plan_memberships#show {:format=>:json}
#                                       PATCH  /api/v1/users/:user_id/plan_membership(.:format)                                         api/v1/plan_memberships#update {:format=>:json}
#                                       PUT    /api/v1/users/:user_id/plan_membership(.:format)                                         api/v1/plan_memberships#update {:format=>:json}
#                                       DELETE /api/v1/users/:user_id/plan_membership(.:format)                                         api/v1/plan_memberships#destroy {:format=>:json}
...
#                                       PATCH  /api/v1/users/:user_id/cart/cart_items/:id(.:format)                                     api/v1/cart_items#update {:format=>:json}
#                                       PUT    /api/v1/users/:user_id/cart/cart_items/:id(.:format)                                     api/v1/cart_items#update {:format=>:json}
